 ...
 */
router.post("/", authorizeRoles("ADMIN"), (req, res) => indicatorController.create(req, res));
 ...
 */
router.put("/:id", authorizeRoles("ADMIN"), (req, res) => indicatorController.update(req, res));
 ...
 */
router.delete("/:id", authorizeRoles("ADMIN"), (req, res) => indicatorController.delete(req, res));
